...
export type Database = {
  public: {
    Tables: {
      ...
      prices: {
        Row: {
          ...
          id: string
          interval:
            | Database["public"]["Enums"]["pricing_plan_interval_new"]
            | null
          interval_count: number | null
          metadata: Json | null
          product_id: string | null
          trial_period_days: number | null
          type: Database["public"]["Enums"]["pricing_type_new"] | null
      ...
      subscriptions: {
        Row: {
          ...
          status: Database["public"]["Enums"]["subscription_status_new"] | null
    ...
    Enums: {
      ...
      pricing_plan_interval_new: "day" | "week" | "month" | "year"
      pricing_type: "one_time" | "recurring"
      pricing_type_new: "one_time" | "recurring"
      subscription_status:
        | "trialing"
        | "active"
        | "canceled"
